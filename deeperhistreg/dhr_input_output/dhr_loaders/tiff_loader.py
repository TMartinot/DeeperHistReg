...
class TIFFLoader(WSILoader):
    ...
    def __init__(self, image_path, mode=LoadMode.NUMPY):
        ...
        self.mode = mode
        self.image = pyvips.Image.tiffload(self.image_path)
    ...
    def get_resolutions(self) -> Iterable[int]:
        ...
        for level in range(self.num_levels):
            image = pyvips.Image.tiffload(self.image_path, page=level)
